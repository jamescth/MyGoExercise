...
/*
 component{
	 log file {
		 PhysicalPath
		 linkPath
		 type			[core,zcore,zdump,datrium log, esx log, misc]
		 startTime		[]
		 endTime		[]
		 startLine  	The starting string when start the process
		 endLine		The ending string when close the process
		 keywords[
		 {
			 key:
...
/*
	esx:
		{path}/var/run/log/
			...
			./scratch/log
			./scratch/log/da_head_rp.log
			./scratch/log/da_head.log
			./scratch/log/datrium_bootstrap_stage1.log
			./scratch/log/dacli.log
			./scratch/log/datrium_hyperdriver.log
			./scratch/log/da_head0.log
			./scratch/log/datrium_bootstrap_stage2.log
			./scratch/log/da_head_init.log
			./scratch/log/datrium_config_agent.log

			/opt/datrium_hyperdriver/Version.txt
			/opt/datrium/etc/dva.conf
	...
	da:
		...
		ctrler:
			...
			{path}/da/data/var/log/platform
			{path}/da/data/var/log/traces/default

		KVM:
			{path}/var/core
			{path}/var/log/datrium
			{path}/opt/datrium/Version.txt
			./opt/datrium/etc
			./opt/datrium/etc/dva.conf
			./commands
			./commands/pacman.log.gz
			./commands/dmesg_e.log.gz
			./commands/rpm_qa_last.log.gz
			./commands/dpkg.log.gz
			./commands/general_commands_output.log.gz
			./commands/journalctl_x_utc.log.gz
...
/*
 DaFile is a struct to represent a log file
 File is the physical path to the log file
 LinkTo is a soft link to the log file.
*/
type DaFile struct {
	File   string
	LinkTo string
